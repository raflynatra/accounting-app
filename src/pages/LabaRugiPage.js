...
const LabaRugiPage = () => {
    ...
    const handleSearch = (e) => {
        ...
        let labaRugiSearch = labaRugi.filter(a => a._id.toLowerCase().includes(e.target.value.toLowerCase()))
        ...
        <div className='container'>
            <div style={styles.row1}>
                ...
                <div className="row pt-2">
                    ...
                    />
                    <button className="btn btn-sm mt-2 col" onClick={handlePrint} style={styles.button}>
                        Cetak
                    </button>
